...
for i=1:n_set
    for j = 1 : n_num
        ...
        same_pair((i-1)*n_num + j,1) = {sprintf('/home/wujiyang/FaceDataSetTools/LFW/aligned112-96/%s/%s_%04d.jpg',p{1},p{1},id1)};
        same_pair((i-1)*n_num + j,2) = {sprintf('/home/wujiyang/FaceDataSetTools/LFW/aligned112-96/%s/%s_%04d.jpg',p{1},p{1},id2)};
        if exist('list','var')
    ...
    for j = 1 : n_num
        ...
        diff_pair((i-1)*n_num + j,1) = {sprintf('/home/wujiyang/FaceDataSetTools/LFW/aligned112-96/%s/%s_%04d.jpg',p1{1},p1{1},id1)};
        diff_pair((i-1)*n_num + j,2) = {sprintf('/home/wujiyang/FaceDataSetTools/LFW/aligned112-96/%s/%s_%04d.jpg',p2{1},p2{1},id2)};
        if exist('list','var')
