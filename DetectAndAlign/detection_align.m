addpath /home/wujiyang/caffe-wujiyang/matlab;

folder = '/home/wujiyang/data/vggface2/test';
addpath('..');
image_list = get_image_list_in_folder(folder);
target_folder = '/home/wujiyang/data/vggface2/test_aligned-224-224';
if exist(target_folder, 'dir')==0
    mkdir(target_folder);
end;

pdollar_toolbox_path='/home/wujiyang/face-verification/tools/piotr_toolbox';
addpath(genpath(pdollar_toolbox_path));

MTCNN_path = '/home/wujiyang/face-verification/tools/MTCNN/code/codes/MTCNNv2';
...
%112*112
% coord5points = [35.2946, 75.5318, 56.0252, 36.5493, 72.7299; ...
%                 45.6963, 45.5014, 65.7366, 86.3655, 86.2041];
%224*224          
 coord5points = [70.5892, 151.0636, 112.0504, 73.0986, 145.4598; ...
                91.3926, 91.3926, 131.4732, 172.7310, 172.4082];
%imgSize = [112, 96]          
%imgSize = [112, 112];
imgSize = [224, 224]   
...
fp = fopen('/home/wujiyang/data/vggface2/detect_none.txt', 'a+');
